...
import { ArrowDown, Folder, FileText, Sparkles, ChevronRight, Terminal } from 'lucide-react';
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        {/* Availability Badge */}
        <motion.div
          className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full glass-card border border-cyan-500/30 text-xs font-mono text-cyan-300 mb-6 shadow-[0_0_15px_rgba(0,240,255,0.2)]"
        ...
        {/* Hero Headline */}
        <motion.h1
          className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight text-white mb-6 leading-none"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* Subtitle / Title */}
        <motion.div
          className="max-w-3xl text-lg sm:text-xl md:text-2xl font-medium text-slate-300 mb-8 leading-relaxed"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* Feature Badges */}
        <motion.div
          className="flex flex-wrap justify-center gap-3 mb-10 text-xs font-mono"
