...
import { X, ExternalLink, CheckCircle2, Cpu, Zap } from 'lucide-react';
...
export function ProjectModal({ project, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-3xl my-8 bg-[#0b1120] border border-cyan-500/30 rounded-2xl shadow-2xl overflow-hidden text-white glass-panel">
        {/* Close Button */}
        <button
          onClick={onClose}
